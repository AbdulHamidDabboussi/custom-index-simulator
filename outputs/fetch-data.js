#!/usr/bin/env node
/* ============================================================
   fetch-data.js — build the offline price bundle (outputs/data.js)
   ------------------------------------------------------------
   ...
   to month-end closes, and writes outputs/data.js, which
   ...
   Usage:
     node outputs/fetch-data.js                 # ~10y, all symbols
     node outputs/fetch-data.js --delay=2500    # gentler pacing (ms)
     node outputs/fetch-data.js --years=8       # shorter history window
     node outputs/fetch-data.js --months=120    # cap stored months
   ============================================================ */
...
(async function main() {
  ...
  const out =
    `/* AUTO-GENERATED by outputs/fetch-data.js — do not edit by hand.\n` +
    `   Regenerate with:  node outputs/fetch-data.js\n` +
